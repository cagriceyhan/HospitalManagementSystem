...
public class BashekimGUI extends JFrame {
	...
	public BashekimGUI(Bashekim bashekim) throws SQLException {
		...
		lblNewLabel.setBounds(10, 10, 573, 35);
		...
		w_doctor.setBackground(new Color(128, 255, 255));
		w_tab.addTab("Doktor Yönetimi", null, w_doctor, null);
		w_doctor.setLayout(null);

		JLabel label = new JLabel("Ad Soyad");
		label.setFont(new Font("Tahoma", Font.PLAIN, 18));
		label.setBounds(584, 10, 100, 29);
		w_doctor.add(label);

		fld_dName = new JTextField();
		fld_dName.setFont(new Font("Tahoma", Font.PLAIN, 12));
		fld_dName.setBounds(584, 50, 143, 19);
		w_doctor.add(fld_dName);
		fld_dName.setColumns(10);

		JLabel label_1 = new JLabel("T.C. No");
		label_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		label_1.setBounds(584, 79, 100, 29);
		w_doctor.add(label_1);

		fld_dTcno = new JTextField();
		fld_dTcno.setFont(new Font("Tahoma", Font.PLAIN, 12));
		fld_dTcno.setColumns(10);
		fld_dTcno.setBounds(584, 118, 143, 19);
		w_doctor.add(fld_dTcno);

		JLabel label_2 = new JLabel("Şifre");
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		label_2.setBounds(584, 147, 100, 29);
		w_doctor.add(label_2);

		fld_dPass = new JPasswordField();
		fld_dPass.setFont(new Font("Tahoma", Font.PLAIN, 12));
		fld_dPass.setBounds(584, 186, 143, 19);
		...
		btn_addDoctor.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btn_addDoctor.setBounds(584, 222, 143, 29);
		w_doctor.add(btn_addDoctor);

		JLabel label_3 = new JLabel("Kullanıcı ID");
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		label_3.setBounds(584, 261, 100, 29);
		w_doctor.add(label_3);

		fld_doctorID = new JTextField();
		fld_doctorID.setEnabled(false);
		fld_doctorID.setFont(new Font("Tahoma", Font.PLAIN, 12));
		fld_doctorID.setBounds(584, 300, 143, 19);
		...
		btn_delDoctor.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btn_delDoctor.setBounds(584, 329, 143, 36);
		w_doctor.add(btn_delDoctor);

		JScrollPane w_scrollDoctor = new JScrollPane();
		w_scrollDoctor.setBounds(10, 10, 564, 355);
		...
		w_clinic.setBackground(new Color(128, 255, 255));
		w_tab.addTab("Poliklinikler", null, w_clinic, null);
		w_clinic.setLayout(null);

		JScrollPane w_scrollClinic = new JScrollPane();
		w_scrollClinic.setBounds(10, 10, 288, 355);
		...
		lblPoliklinikAd.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblPoliklinikAd.setBounds(313, 10, 100, 29);
		w_clinic.add(lblPoliklinikAd);

		fld_clinicName = new JTextField();
		fld_clinicName.setFont(new Font("Tahoma", Font.PLAIN, 12));
		fld_clinicName.setColumns(10);
		fld_clinicName.setBounds(313, 49, 143, 26);
		...
		btn_addClinic.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btn_addClinic.setBounds(313, 85, 143, 45);
		w_clinic.add(btn_addClinic);

		JScrollPane w_scrollWorker = new JScrollPane();
		w_scrollWorker.setBounds(469, 10, 282, 355);
		...
		select_doctor.setBounds(313, 257, 143, 45);
		for (int i = 0; i < bashekim.getDoctorList().size(); i++) {
		...
		btn_addWorker.setBounds(313, 312, 144, 45);
		w_clinic.add(btn_addWorker);

		JLabel lblPoliklinikAd_1 = new JLabel("Poliklinik Adı");
		lblPoliklinikAd_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblPoliklinikAd_1.setBounds(313, 147, 100, 29);
		...
		btn_workerSelect.setBounds(313, 176, 143, 45);
