...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_pane = new JPanel();
		w_pane.setBackground(new Color(128, 128, 0));
		w_pane.setBorder(new EmptyBorder(5, 5, 5, 5));

		setContentPane(w_pane);
		w_pane.setLayout(null);

		JLabel lblNewLabel_1 = new JLabel("Hoşgeldiniz, Sayın, " + hasta.getName());
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblNewLabel_1.setBounds(10, 10, 573, 35);
		...
		btnNewButton_1.setBounds(593, 13, 183, 35);
		...
		lblNewLabel.setBounds(10, 10, 156, 36);
		...
		lblPoliklinikAd.setBounds(303, 50, 100, 29);
		w_appointment.add(lblPoliklinikAd);

		JComboBox select_clinic = new JComboBox();
		select_clinic.setFont(new Font("Tahoma", Font.PLAIN, 16));
		select_clinic.setBounds(303, 89, 147, 41);
		...
		lblPoliklinikAd_1.setBounds(303, 140, 100, 29);
		...
		btn_selDoctor.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btn_selDoctor.setBounds(303, 176, 143, 45);
		w_appointment.add(btn_selDoctor);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(460, 50, 291, 315);
		...
		JLabel lblNewLabel_2 = new JLabel("Randevu Saatleri");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblNewLabel_2.setBounds(460, 10, 256, 36);
		w_appointment.add(lblNewLabel_2);

		JLabel lblPoliklinikAd_1_1 = new JLabel("Randevu");
		lblPoliklinikAd_1_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblPoliklinikAd_1_1.setBounds(303, 262, 100, 29);
		...
		btn_addAppoint.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btn_addAppoint.setBounds(303, 298, 143, 45);
		w_appointment.add(btn_addAppoint);

		JPanel w_appoint = new JPanel();
		w_appoint.setBackground(new Color(128, 128, 64));
		w_tab.addTab("Randevularım", null, w_appoint, null);
		w_appoint.setLayout(null);

		JScrollPane w_scrollAppoint = new JScrollPane();
		w_scrollAppoint.setBounds(10, 10, 741, 355);
